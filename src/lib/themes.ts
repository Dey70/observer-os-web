...
export const THEMES: ThemeDefinition[] = [
  ...
  },
  {
    ...
    category: "full-aesthetic",
    previewBg: "#FBF3F4",
    previewAccent: "#E58AA0",
    description: "Blossom-pink and fresh green on a soft pastel surface, with a sakura petal pattern.",
  },
  {
    id: "summer",
    label: "Summer",
    category: "full-aesthetic",
    previewBg: "#EAF6F6",
    previewAccent: "#1B9C85",
    description: "Ocean teal and coral on a bright pale-aqua surface, with a wave-line pattern.",
  },
  {
    id: "autumn",
    label: "Autumn",
    category: "full-aesthetic",
    previewBg: "#241209",
    previewAccent: "#D97B29",
    description: "Deep bark-brown with pumpkin and maple tones, with a falling-leaf pattern.",
  },
  {
    id: "winter",
    label: "Winter",
    category: "full-aesthetic",
    previewBg: "#0B1E33",
    previewAccent: "#7EC8E3",
    description: "Deep frosted navy with icy cyan, with a drifting snowflake pattern.",
  },
  {
    id: "stranger-things",
    ...
    category: "full-aesthetic",
    previewBg: "#0A0A0C",
    previewAccent: "#E8000D",
    description: "Neon-red 80s horror on near-black, flickering glow, drifting spores, and a condensed retro font.",
  },
  {
    id: "marvel",
    label: "Marvel",
    category: "full-aesthetic",
    previewBg: "#0D0D0D",
    previewAccent: "#ED1D24",
    description: "Comic-book red and gold on ink black, a halftone-dot pattern, and a bold condensed font.",
  },
  {
    ...
    category: "full-aesthetic",
    previewBg: "#170D12",
    previewAccent: "#C08A3E",
    description: "Gothic Victorian brass and emerald on deep burgundy-black, a Garamond serif, and an occult sigil motif.",
  },
];
